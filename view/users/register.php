	...
	<div id="register">
    	...
    	<form action="index.php?page=register" method="post" enctype="multipart/form-data" >
    		<div class="registerForm">
				...
				<input id="firstname" type="text" name="firstname" value="<?php if(!empty($_POST['firstname'])) echo $_POST['firstname'];?>"></input>
				<?php if(!empty($errors['firstname'])) echo '</br> <span>' . $errors['firstname'] . '</span>'; ?>
			</div>
			<div class="registerForm">
				<label for="lastname">Lastname:</label>
				<input id="lastname" type="text" name="lastname" value="<?php if(!empty($_POST['lastname'])) echo $_POST['lastname'];?>"></input>
			...
			<div class="registerForm">
				...
				<input id="email" type="email" name="email" value="<?php if(!empty($_POST['email'])) echo $_POST['email'];?>"></input>
